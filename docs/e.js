...
async function sell() {
	...
	if(alvo[0]==false) {
		notice(`
			...
			El Ramses Depositor requires your approval to complete this conversion.<br><br>
	...
	if(alvo[1]==true) {
		notice(`
			...
			El Ramses Depositor requires your veNFT to be in a non-voted state to complete this conversion.
			<br><br>
